<script lang="ts">
	...
	let { class: className = 'h-8 w-8' }: Props = $props();
</script>

<!-- Official shadcn/ui logo from Simple Icons -->
<svg class={className} viewBox="0 0 24 24" fill="#000000" xmlns="http://www.w3.org/2000/svg" role="img">
