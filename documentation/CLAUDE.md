# JabStack - Claude/Cursor/Windsurf Context

> **Note**: This file exists for tools that auto-detect `CLAUDE.md`. The main context document is [`LLM_CONTEXT.md`](./LLM_CONTEXT.md).

For full project context, read:
1. [`documentation/LLM_CONTEXT.md`](./LLM_CONTEXT.md) - Quick reference for AI assistants
2. [`plans/jabstack-architecture.md`](../plans/jabstack-architecture.md) - Detailed architecture with diagrams
...
See `.mcp/` directory for configurations.
